...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      {!user ? (
        // 未登录时显示的欢迎页面
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white min-h-screen flex items-center">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-6xl font-bold mb-8">欢迎使用奖学金助手</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                ...
                <p className="text-lg">成功案例</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <h3 className="text-2xl font-bold mb-4">500+</h3>
                <p className="text-lg">合作院校</p>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                <h3 className="text-2xl font-bold mb-4">全球</h3>
                <p className="text-lg">奖学金覆盖</p>
              </div>
            </div>
            <Button
              size="lg"
            ...
            <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
              <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-xl mb-8 max-w-3xl mx-auto">
                  欢迎回来，{user.name || user.email}！准备好寻找适合您的奖学金了吗？
                </p>
                <Button
                  size="lg"
